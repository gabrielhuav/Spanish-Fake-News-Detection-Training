# train_bert_base_multilingual.py - PyTorch Backend (Lightning AI Studio)
# mBERT Fine-Tuning: Physical Checkpoints, TQDM, Anti-OOM, and 5 Metrics
...
def load_and_prepare_data(batch_size=16):
    ...
    # Corrección: Eliminado use_auth_token=False
...
def main():
    ...
    if os.path.exists(CHECKPOINT_PATH):
        print("\n[+] Checkpoint found in Persistent Storage. Skipping Tuning Phase...")
        best_lr = 5e-6
        best_dropout = 0.3
        best_batch_size = 16
    else:
