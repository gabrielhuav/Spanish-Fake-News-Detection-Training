# train_roberta_large_bne.py - PyTorch Backend (Lightning AI Studio)
# RoBERTa-Large-BNE Fine-Tuning: Anti-OOM, CSV History Tracking, and Automated Plotting
...
# ==============================================================================
MODEL_NAME = 'illuin/roberta-large-bne'
MAX_LENGTH = 128

STUDIO_PATH = "/teamspace/studios/this_studio"
DATASET_PATH = f"{STUDIO_PATH}/corpus_unificado_3_clases_final.csv"
FINAL_MODEL_PATH = f"{STUDIO_PATH}/final_model_roberta_large_bne_3_classes"
RESULTS_FILE = f"{STUDIO_PATH}/academic_results_roberta_large_bne.txt"
CHECKPOINT_PATH = f"{STUDIO_PATH}/checkpoint_roberta_large_bne.pt" 
HISTORY_FILE = f"{STUDIO_PATH}/training_history_roberta_large_bne.csv"
...
def generate_convergence_plot(history_path, best_epoch):
    ...
    ax_main_acc.set_title('RoBERTa-Large-BNE Convergence Analysis', fontsize=16, fontweight='bold')
    ...
    plt.tight_layout()
    plot_path = f"{STUDIO_PATH}/academic_convergence_roberta_large_bne.png"
...
def plot_confusion_matrix(y_true, y_pred):
    ...
    plt.title('Confusion Matrix - RoBERTa-Large-BNE', fontsize=14, fontweight='bold')
    plt.ylabel('True Label', fontsize=12)
    plt.xlabel('Predicted Label', fontsize=12)
    plt.savefig(f'{STUDIO_PATH}/academic_confusion_matrix_roberta_large_bne.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def main():
    print("=" * 80)
    print("FINE-TUNING: RoBERTa-Large-BNE (LIGHTNING AI STUDIO)")
    print("=" * 80)
    ...
    # FORCE BATCH SIZE 8 TO PREVENT OOM ON LARGE MODELS
    best_batch_size = 8 
    best_lr = 5e-6
    best_dropout = 0.3
    ...
    print(f"\n[INFO] Phase 3: Final Training (Forced Batch Size: {best_batch_size})")
    ...
    academic_report = (
        "====================================================\n"
        "FINAL ACADEMIC METRICS (RoBERTa-Large-BNE)\n"
        "====================================================\n"
