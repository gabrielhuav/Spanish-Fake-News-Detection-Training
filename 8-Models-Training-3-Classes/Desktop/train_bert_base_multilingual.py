# train_mbert.py - PyTorch Backend (Lightning AI Studio)
# mBERT Fine-Tuning: Anti-OOM, CSV History Tracking, and Automated Plotting
...
FINAL_MODEL_PATH = f"{STUDIO_PATH}/final_model_mbert_3_classes"
RESULTS_FILE = f"{STUDIO_PATH}/academic_results_mbert.txt"
CHECKPOINT_PATH = f"{STUDIO_PATH}/checkpoint_mbert.pt" 
HISTORY_FILE = f"{STUDIO_PATH}/training_history_mbert.csv"
...
def generate_convergence_plot(history_path, best_epoch):
    ...
    ax_main_acc.set_title('mBERT Convergence Analysis (3 Classes)', fontsize=16, fontweight='bold')
    ...
    plt.tight_layout()
    plot_path = f"{STUDIO_PATH}/academic_convergence_mbert.png"
...
def plot_confusion_matrix(y_true, y_pred):
    ...
    plt.title('Confusion Matrix - mBERT (Multilingual)', fontsize=14, fontweight='bold')
    plt.ylabel('True Label', fontsize=12)
    plt.xlabel('Predicted Label', fontsize=12)
    plt.savefig(f'{STUDIO_PATH}/academic_confusion_matrix_mbert.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def main():
    print("=" * 80)
    print("FINE-TUNING: mBERT (LIGHTNING AI STUDIO)")
    print("=" * 80)
