# train_roberta_base_bne.py - PyTorch Backend (Lightning AI Studio)
# RoBERTa-Base-BNE Fine-Tuning: Physical Checkpoints, TQDM, Anti-OOM, and 5 Metrics
...
FINAL_MODEL_PATH = f"{STUDIO_PATH}/final_model_roberta_base_bne_3_classes"
RESULTS_FILE = f"{STUDIO_PATH}/academic_results_roberta_base_bne.txt"
CHECKPOINT_PATH = f"{STUDIO_PATH}/checkpoint_roberta_base_bne.pt" 
...
def plot_confusion_matrix(y_true, y_pred):
    ...
    plt.title('Confusion Matrix - RoBERTa-Base-BNE', fontsize=14, fontweight='bold')
    plt.ylabel('True Label', fontsize=12)
    plt.xlabel('Predicted Label', fontsize=12)
    plt.savefig(f'{STUDIO_PATH}/academic_confusion_matrix_roberta_base_bne.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def main():
    print("=" * 80)
    print("FINE-TUNING: RoBERTa-Base-BNE (LIGHTNING AI STUDIO)")
    print("=" * 80)
    ...
    academic_report = (
        "====================================================\n"
        "FINAL ACADEMIC METRICS (RoBERTa-Base-BNE)\n"
        "====================================================\n"
