# train_xlmr_base.py - PyTorch Backend (Lightning AI Studio)
# XLM-RoBERTa-Base Fine-Tuning: Physical Checkpoints, TQDM, Anti-OOM, and 5 Metrics
...
FINAL_MODEL_PATH = f"{STUDIO_PATH}/final_model_xlmr_base_3_classes"
RESULTS_FILE = f"{STUDIO_PATH}/academic_results_xlmr_base.txt"
CHECKPOINT_PATH = f"{STUDIO_PATH}/checkpoint_xlmr_base.pt" 
...
def plot_confusion_matrix(y_true, y_pred):
    ...
    plt.savefig(f'{STUDIO_PATH}/academic_confusion_matrix_xlmr_base.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def main():
    print("=" * 80)
    print("FINE-TUNING: XLM-RoBERTa-Base (LIGHTNING AI STUDIO)")
    print("=" * 80)
    ...
    academic_report = (
        "====================================================\n"
        "FINAL ACADEMIC METRICS (XLM-RoBERTa-Base)\n"
        "====================================================\n"
