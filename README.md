...
This section documents the materials added during the second round of review
(Informatics, MDPI; Manuscript ID informatics-4202664). Each item is mapped to
the reviewer comment it addresses. All files are in
...
This experiment is the basis for the *Cross-Source Generalization of the Satire
Class* analysis and the finding that per-class corpus source diversity is the
...
> The deployment latency benchmark (also requested this round) is hosted in the
> companion web-application repository, `Spanish-Fake-News-Detection-Web-App`,
> under `revision_round2_latency/`.